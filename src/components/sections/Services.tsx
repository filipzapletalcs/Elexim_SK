...
export default function Services() {
  ...
  return (
    <section id="sluzby" className="py-24 lg:py-32 bg-white relative overflow-hidden">
      {/* Subtle background */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-primary-50/40 via-transparent to-transparent" />
            ...
            return (
              ...
              >
                <Link href="/sluzby" className="group block h-full">
                  <div className="h-full bg-secondary-50 rounded-2xl p-7 hover:bg-primary-600 transition-all duration-500 border border-secondary-100 hover:border-primary-600 relative overflow-hidden">
                    <div className="relative">
                      {/* Icon */}
                      <div className="w-12 h-12 rounded-xl bg-primary-100 group-hover:bg-white/20 flex items-center justify-center mb-5 transition-colors duration-500">
                        <Icon size={24} className="text-primary-600 group-hover:text-white transition-colors duration-500" />
                      </div>

                      {/* Content */}
                      <h3 className="font-[family-name:var(--font-inter)] text-lg font-bold text-secondary-900 group-hover:text-white mb-2 transition-colors duration-500">
                        {t(`${service.key}.title`)}
                      </h3>
                      <p className="text-secondary-600 group-hover:text-white/80 text-sm leading-relaxed transition-colors duration-500">
