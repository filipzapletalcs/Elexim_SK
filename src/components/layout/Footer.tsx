          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <MapPin size={16} className="text-secondary-400 dark:text-white/90 flex-shrink-0 mt-0.5" />
                <span className="text-secondary-600 dark:text-white/90 text-sm leading-relaxed">
                  {contact("addressValue")}
                </span>
              </li>
              <li className="flex items-center gap-3">
                <Phone size={16} className="text-secondary-400 dark:text-white/90 flex-shrink-0" />
                <a
              ...
              <li className="flex items-center gap-3">
                <Mail size={16} className="text-secondary-400 dark:text-white/90 flex-shrink-0" />
                <a
