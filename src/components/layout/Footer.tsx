        ...
        <div className="py-16 lg:py-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-4">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-white hover:text-white/80 transition-colors text-sm group"
            >
              elexim.net
          ...
          <div className="lg:col-span-2">
            <h3 className="font-semibold text-white mb-4">{footer("quickLinks")}</h3>
          ...
          <div className="lg:col-span-3">
            <h3 className="font-semibold text-white mb-4">{footer("contactInfo")}</h3>
          ...
          {/* Company Details */}
          <div className="lg:col-span-3">
            <h3 className="font-semibold text-white mb-2">ELEXIM SK, s.r.o.</h3>
            <p className="text-white/90 text-sm">IČO: 51818612</p>
            <p className="text-white/90 text-sm mb-4">DIČ: SK2120801155</p>
